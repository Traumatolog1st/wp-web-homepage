...
<footer>
	<div class="contact-us">
		<!-- <form action="" method="post">
			<h1>Contact Us</h1>
			<div class="form-item">
			<h2>Name</h2><input type="text" name="f-name" placeholder="First"></div>
			<div class="form-item">
			<input type="text" name="l-name" placeholder="Last"></div>
			<div class="form-item">
			<h2>Email</h2><input type="email" name="email"></div>
			<div class="form-item">
